...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Mistral-7B Czarnowska Prompting")
    ...
    PREDICTION_FILE_PATH = f"{PREDICTION_STUB}/mistral_7b/mistral_7b_prompt_predictions_zero_cot_{run_id}.tsv"
