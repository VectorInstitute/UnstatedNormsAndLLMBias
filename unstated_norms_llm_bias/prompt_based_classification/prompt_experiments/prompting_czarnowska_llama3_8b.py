...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Llama3-8B Czarnowska Prompting")
    ...
    PREDICTION_FILE_PATH = f"{PREDICTION_STUB}/llama3_8b/llama3_8b_prompt_predictions_{dataset}_{run_id}.tsv"
