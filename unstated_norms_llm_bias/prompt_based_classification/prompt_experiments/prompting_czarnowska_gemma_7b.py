...
MODEL_PATH = "/model-weights/gemma-7b-it"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Gemma-7B Czarnowska Prompting")
    ...
    PREDICTION_FILE_PATH = f"{PREDICTION_STUB}/gemma_7b/gemma_7b_prompt_predictions_{dataset}_{run_id}.tsv"
