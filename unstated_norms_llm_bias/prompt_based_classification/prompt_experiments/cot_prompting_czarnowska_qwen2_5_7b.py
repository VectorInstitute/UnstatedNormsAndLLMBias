...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Qwen2_5-7B Czarnowska Prompting")
    ...
    PREDICTION_FILE_PATH = f"{PREDICTION_STUB}/qwen2_5_7b/qwen2_5_7b_prompt_predictions_zero_cot_{run_id}.tsv"
